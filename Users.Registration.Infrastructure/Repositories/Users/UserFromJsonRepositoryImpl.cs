...
{
    public class UserFromJsonRepositoryImpl : IUserRepository
    {
        ...
        private List<UserData> GetUsers()
        {
            ...
            {
                new UserData() { Id = 1, FirstName = "LastName: Иван", LastName = "LastName: Иванов", MiddleName = "MiddleName: Иванович", Age = 20},
                new UserData() { Id = 2, FirstName = "FirstName: Александр", LastName = "LastName: Сергеев", MiddleName = "MiddleName: Александрович", Age = 25},
                new UserData() { Id = 3, FirstName = "FirstName: Петр", LastName = "LastName: Васильев", MiddleName = "MiddleName: Петорович", Age = 35}
            };
            return usersData;
        }
    }
